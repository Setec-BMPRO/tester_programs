    ...
    def test_pass_run(self):
        ...
        data = {
            UnitTester.key_sen: {       # Tuples of sensor data
                'PowerUp': (
                    (sen['olock'], 0.0), (sen['o20VL'], 21.0),
                    (sen['o_20V'], -21.0), (sen['o5V'], 0.0),
                    (sen['o15V'], 15.0), (sen['o_15V'], -15.0),
                    (sen['o15Vp'], 0.0), (sen['o15VpSw'], 0.0),
                    (sen['oPwrGood'], 0.0),
                    ),
                'KeySwitch': (
                    (sen['o5V'], 5.0), (sen['o15V'], 15.0),
                    (sen['o_15V'], -15.0), (sen['o15Vp'], 15.0),
                    (sen['o15VpSw'], (0.0, 15.0)), (sen['oPwrGood'], 5.0),
                    ),
                'ACurrent': (
        ...
        self.assertEqual(
            ['PowerUp', 'KeySwitch', 'ACurrent', 'OCP'],
