...
class Final2V(share.TestSequence):
    ...
    def _step_power_up(self, dev, mes):
        ...
        self.measure(
            ('dmm_5Vsb', 'ui_YesNoGreen', 'dmm_24Voff', 'dmm_12Voff',
             'dmm_5Voff', 'dmm_3V3off', 'dmm_n12Voff', 'dmm_PwrGoodOff',
             'dmm_PwrFailOff'),
            timeout=5)
    ...
    def _step_switch_on(self, dev, mes):
        ...
        self.measure(
            ('dmm_24Von', 'dmm_12Von', 'dmm_5Von', 'dmm_3V3on', 'dmm_n12Von',
             'dmm_PwrGoodOn', 'dmm_PwrFailOn', 'ui_YesNoFan'),
            timeout=5)
    ...
    def _step_full_load(self, dev, mes):
        ...
        self.dcload(
            (('dcl_5Vsb', 1.0), ('dcl_24V', 5.0), ('dcl_5V', 10.0),
             ('dcl_12V', 10.0), ('dcl_3V3', 10.0), ), delay=0.5)
        self.measure(
            ('dmm_5Vsb', 'dmm_24Von', 'dmm_12Von', 'dmm_5Von', 'dmm_3V3on',
             'dmm_n12Von', 'dmm_PwrGoodOn', 'dmm_PwrFailOn'), timeout=5)
        # Drop back to minimum loads
        self.dcload(
            (('dcl_5Vsb', 0.0), ('dcl_24V', 0.5), ('dcl_12V', 0.5),
             ('dcl_5V', 0.5), ('dcl_3V3', 0.0), ))
...
class LogicalDevices(share.LogicalDevices):
    ...
    def reset(self):
        ...
        self['acsource'].reset()
        for ld in (
                'dcl_24V', 'dcl_12V', 'dcl_5V','dcl_3V3', 'dcl_5Vsb'):
