...
PROGRAMS = (
    ...
    ('CMR-INI', cmrsbp.MainInitial, cmrsbp.LIMIT_DATA),
    ('CMR-SD', cmrsbp.MainSerialDate, cmrsbp.LIMIT_DATA),
    ('CMR8D-FIN', cmrsbp.MainFinal, cmrsbp.LIMIT_DATA_8D),
    ('CMR13F-FIN', cmrsbp.MainFinal, cmrsbp.LIMIT_DATA_13F),
    ('CMR17L-FIN', cmrsbp.MainFinal, cmrsbp.LIMIT_DATA_17L),
