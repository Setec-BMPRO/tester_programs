...
class Initial(share.TestSequence):
    ...
    limitdata = (
        libtester.LimitBetween("FanConn", 100, 200),
        libtester.LimitBetween("InrushOff", 120, 180),
        libtester.LimitLow("InrushOn", 10),
        libtester.LimitBetween("SecCtlExt", 12.8, 14.0),
        libtester.LimitBetween("SecCtl2Ext", 13.6, 14.0),
        libtester.LimitBetween("SecCtl", 9.6, 15.0),
        libtester.LimitBetween("SecCtl2", 7.0, 15.0),
        libtester.LimitBetween("LedOn", 1.5, 2.2),
        libtester.LimitBetween("LedOff", -0.1, 0.1),
        libtester.LimitBetween("FanOff", 13.4, 14.0),
        libtester.LimitBetween("FanOn", -0.5, 1.0),
        libtester.LimitLow("inVP", 12.5),
        libtester.LimitBetween("OVP", 14.95, 16.45),
        libtester.LimitBetween("UVP", 9.96, 10.96),
        libtester.LimitDelta("VbusExt", 120.0, 2.0),
        libtester.LimitLow("VbusOff", 70.0),
        libtester.LimitBetween("Vbus", 380.0, 410.0),
        libtester.LimitBetween("Vbias", 11.2, 12.8),
        libtester.LimitBetween("AcDetOff", -0.1, 6.0),
        libtester.LimitBetween("AcDetOn", 8.0, 14.0),
        libtester.LimitDelta("VacMin", 100.0, 5.0),
        libtester.LimitDelta("Vac", 240.0, 5.0),
        libtester.LimitBetween("VoutExt", 13.6, 14.0),
        libtester.LimitBetween("VoutPre", 12.6, 15.0),
        libtester.LimitBetween("VoutSet", 13.775, 13.825),
        libtester.LimitBetween("Vout", 13.5, 13.825),
        libtester.LimitLow("VoutOff", 5.0),
        libtester.LimitLow("Reg", 2.0),
        libtester.LimitBetween("SecShdnOff", 12.5, 13.5),
        libtester.LimitBetween("PwmShdnOn", 9.0, 15.0),
        libtester.LimitLow("PwmShdnOff", 1.0),
        libtester.LimitBetween("VacShdnOn", 9.0, 15.0),
        libtester.LimitLow("VacShdnOff", 1.0),
