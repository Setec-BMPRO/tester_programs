...
class InitialAux(share.TestSequence):
    ...
    def _step_pwrup(self, dev, mes):
        ...
        self.measure(
            ('dmm_20VL', 'dmm__20V', 'dmm_5Voff', 'dmm_15V', 'dmm__15V',
             'dmm_15Vpoff', 'dmm_15Vpswoff', 'dmm_pwrgoodoff', ),
             timeout=5)
    ...
    def _step_key_switch(self, dev, mes):
        ...
        self.measure(
            ('dmm_5V', 'dmm_15V', 'dmm__15V', 'dmm_15Vp', 'dmm_15Vpswoff',
             'dmm_pwrgood', ),
             timeout=5)
    ...
    def _step_acurrent(self, dev, mes):
        ...
        self.dcload((('dcl_5V', 0.0), ('dcl_15Vp', 0.0), ))
        self.measure(('dmm_ac5V_1', 'dmm_ac15V_1', ), timeout=5)
        dev['dcl_5V'].output(6.0)
        self.measure(('dmm_ac5V_2', 'dmm_ac15V_1', ), timeout=5)
        dev['dcl_15Vp'].output(4.0)
        self.measure(('dmm_ac5V_2', 'dmm_ac15V_2', ), timeout=5)
        self.dcload((('dcl_5V', 0.0), ('dcl_15Vp', 0.0), ))
    ...
    def _step_ocp(self, dev, mes):
        ...
        dev['rla_enAux'].set_on()
        self.measure(('dmm_15Vp', 'ramp_OCP15Vp', 'dmm_auxtemp',), timeout=5)
...
class Devices(share.Devices):
    ...
    def reset(self):
        ...
        for dcs in ('dcs_5Vfix', 'dcs_fan', ):
            self[dcs].output(0.0, False)
        for dcl in ('dcl_5V', 'dcl_15Vp', ):
            self[dcl].output(0.0, False)
        for rla in ('rla_enAux', 'rla_en15Vpsw', ):
            self[rla].set_off()
