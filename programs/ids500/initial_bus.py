...
class InitialBus(share.TestSequence):
    ...
    # Test limits
    limitdata = (
        LimitBetween('400V', 390, 410),
        LimitBetween('20VT_load0_out', 22.0, 24.0),
        LimitBetween('9V_load0_out', 10.8, 12.0),
        LimitBetween('20VL_load0_out', 22.0, 24.0),
        LimitBetween('-20V_load0_out', -25.0, -22.0),
        LimitBetween('20VT_load1_out', 22.0, 25.0),
        LimitBetween('9V_load1_out', 9.0, 11.0),
        LimitBetween('20VL_load1_out', 22.0, 25.0),
        LimitBetween('-20V_load1_out', -26.0, -22.0),
        LimitBetween('20VT_load2_out', 19.0, 24.0),
        LimitBetween('9V_load2_out', 9.0, 11.0),
        LimitBetween('20VL_load2_out', 19.0, 21.5),
        LimitBetween('-20V_load2_out', -22.2, -20.0),
        LimitBetween('20VT_load3_out', 17.5, 20.0),
        LimitBetween('9V_load3_out', 9.0, 12.0),
        LimitBetween('20VL_load3_out', 22.0, 24.0),
        LimitBetween('-20V_load3_out', -26.0, -22.0),
    ...
    def open(self):
        ...
        self.steps = (
            ...
            TestStep('TecLddStartup', self._step_tec_ldd),
            )
    ...
    def _step_pwrup(self, dev, mes):
        ...
        self.dcsource((('dcs_prictl', 13.0), ('dcs_fan', 12.0), ))
    ...
    def _step_tec_ldd(self, dev, mes):
        """ """
        self.relay(
            (('rla_enBC20', True), ('rla_enT', True),
             ('rla_enBC9', True), ('rla_enL', True), ))
        self.dcload(
            (('dcl_20VT', 0.0), ('dcl_9V', 0.0),
             ('dcl_20VL', 0.0), ('dcl__20', 0.0), ))
        self.measure(
            ('dmm_20VT_0', 'dmm_9V_0', 'dmm_20VL_0', 'dmm__20V_0', ),
            timeout=5)
        dev['dcl_9V'].output(10.0)
        self.measure(
            ('dmm_20VT_1', 'dmm_9V_1', 'dmm_20VL_1', 'dmm__20V_1', ),
            timeout=5)
        self.dcload((('dcl_20VL', 2.0), ('dcl__20', 0.4), ))
        self.measure(
            ('dmm_20VT_2', 'dmm_9V_2', 'dmm_20VL_2', 'dmm__20V_2', ),
            timeout=5)
        self.dcload(
            (('dcl_20VT', 15.0), ('dcl_9V', 0.0), ('dcl_20VL', 0.0),
             ('dcl__20', 0.0), ))
        self.measure(
            ('dmm_20VT_3', 'dmm_9V_3', 'dmm_20VL_3', 'dmm__20V_3', ),
            timeout=5)
...
class Devices(share.Devices):
    ...
    def reset(self):
        ...
        for dcs in ('dcs_prictl', 'dcs_fan', ):
            self[dcs].output(0.0, False)
        for dcl in ('dcl_20VT', 'dcl_9V', 'dcl_20VL', 'dcl__20', ):
            self[dcl].output(0.0, False)
        for rla in ('rla_enT', 'rla_enBC9', 'rla_enL', 'rla_enBC20', ):
            self[rla].set_off()
