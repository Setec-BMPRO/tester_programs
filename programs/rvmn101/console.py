...
class ConsoleA(share.console.Base):

    """Communications to RVMN101A console."""

# FIXME: Update the RVMN101A console
    ...
    def brand(self, sernum, product_rev, hw_rev):
        ...
        @param hw_rev Hardware revision from Prod. Notes.
...
class ConsoleB(share.console.Base):
