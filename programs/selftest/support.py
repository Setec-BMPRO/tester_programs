...
class Measurements(object):
    ...
    def __init__(self, sense, limits):
        ...
        # AC Source
        self.dmm_Acs = (
            (120.0, Measurement(limits['Acs120'], sense.Acs)),
            (240.0, Measurement(limits['Acs240'], sense.Acs)))
        # DC Loads
        self.dmm_Shunt = (
            (5.0, Measurement(limits['Dcl05'], sense.shunt)),
            (10.0, Measurement(limits['Dcl10'], sense.shunt)),
            (20.0, Measurement(limits['Dcl20'], sense.shunt)),
            (40.0, Measurement(limits['Dcl40'], sense.shunt)))
        # Relay Drivers
