...
class _Console:
    ...
    cmd_data = {
        ...
        "SR_HW_VER": parameter.Float("SOLAR_REG_HW_VERS", writeable=True, scale=1),
        "SR_VSET": parameter.Float("SOLAR_REG_V", writeable=True, scale=1000),
        "SR_ISET": parameter.Float("SOLAR_REG_I", writeable=True, scale=1000),
        "SR_VCAL": parameter.Float("SOLAR_REG_CAL_V_OUT", writeable=True, scale=1000),
        "SR_ICAL": parameter.Float("SOLAR_REG_CAL_I_OUT", writeable=True, scale=1000),
        "SR_IOUT": parameter.Float("SOLAR_REG_IOUT", scale=1000),
        "SR_DEL_CAL": parameter.Boolean("SOLAR_REG_DEL_CAL", writeable=True),
        "SR_VIN": parameter.Float("SOLAR_REG_VIN", scale=1000),
        "SR_VIN_CAL": parameter.Float("SOLAR_REG_CAL_V_IN", writeable=True, scale=1000),
