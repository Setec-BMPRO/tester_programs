...
class _Console:
    ...
    cmd_data = {
        ...
        "PROMPT": parameter.String("PROMPT", writeable=True, write_format='"{0} {1}'),
        "STATUS": parameter.Hex(
            "STATUS", writeable=True, minimum=0, maximum=0xF0000000
        ),
        "CAN_BIND": parameter.Hex(
            "STATUS", writeable=True, minimum=0, maximum=0xF0000000, mask=_can_bound
        ),
        ...
        "BACKLIGHT": parameter.Float(
            "BACKLIGHT_INTENSITY", writeable=True, minimum=0, maximum=100, scale=1
        ),
        "CONFIG": parameter.Hex("CONFIG", writeable=True, minimum=0, maximum=0xFFFF),
        "TANK_SPEED": parameter.Float(
            "ADC_SCAN_INTERVAL_MSEC", writeable=True, minimum=0, maximum=10, scale=1000
        ),
        # Tank levels
