...
class Initial(share.TestSequence):
    ...
    def _step_solar(self, dev, mes):
        ...
        j35["SOLAR"] = True
        measurement = "dmm_vair" if self.cfg.air else "dmm_vbatout"
    ...
    def _step_powerup(self, dev, mes):
        ...
        self.measure(("dmm_acin", "dmm_vbus", "dmm_12vpri", "arm_vout_ov"), timeout=5)
        j35.dcdc_on()
    ...
    def open(self):
        ...
        self["ocp_pre"] = sensor.Ramp(
            ...
            ramp_range=sensor.RampRange(
                start=low - load_current - 1, stop=high - load_current + 1, step=0.1
            ),
        )
        ...
        self["solar_input"] = sensor.Ramp(
            ...
            ramp_range=sensor.RampRange(start=low - 0.1, stop=high + 0.1, step=0.05),
        )
