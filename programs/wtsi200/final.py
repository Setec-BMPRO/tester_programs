...
class Final(share.TestSequence):
    ...
    def _step_tank1(self, dev, mes):
        ...
        mes["dso_Tank1Level4"]()
        self.relay(
            (("rla_tank1S3", False), ("rla_tank1S2", False), ("rla_tank1S1", False))
        )
    ...
    def _step_tank2(self, dev, mes):
        ...
        mes["dso_Tank2Level4"]()
        self.relay(
            (("rla_tank2S3", False), ("rla_tank2S2", False), ("rla_tank2S1", False))
        )
    ...
    def _step_tank3(self, dev, mes):
        ...
        mes["dso_Tank3Level4"]()
        self.relay(
            (("rla_tank3S3", False), ("rla_tank3S2", False), ("rla_tank3S1", False))
        )
...
class Sensors(share.Sensors):
    ...
    def open(self):
        ...
        tbase = sensor.Timebase(range=0.20, main_mode=True, delay=0, centre_ref=False)
        trg = sensor.Trigger(ch=4, level=1.0, normal_mode=True, pos_slope=True)
        rdgs = []
        for ch in range(1, 4):
        ...
        self["oTankLevels"] = sensor.DSO(dso, chans, tbase, trg, rdgs, single=True)
        dispatcher.connect(
