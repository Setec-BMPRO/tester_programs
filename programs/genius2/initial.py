...
class Initial(share.TestSequence):
    ...
    def _step_vout_adj(self, dev, mes):
        ...
        dev["dcl"].output(2.0)
        self.measure(("dmm_vout", "dmm_vbatctl", "dmm_vbat", "dmm_vdd"), timeout=5)
...
class Devices(share.Devices):
    ...
    def reset(self):
        ...
        for dev in ("dcs_vout", "dcs_vbat", "dcs_vaux", "dcs_vbatctl", "dcl"):
    ...
    def open(self):
        ...
        self["oOCP"] = sensor.Ramp(
            ...
            ramp_range=sensor.RampRange(
                start=Initial._ocp_low - 1.0, stop=Initial._ocp_high + 1.0, step=0.2
            ),
        )
